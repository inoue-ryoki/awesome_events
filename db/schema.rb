...
ActiveRecord::Schema.define(version: 2023_11_16_000007) do
  ...
  create_table "tickets", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
    t.bigint "user_id"
